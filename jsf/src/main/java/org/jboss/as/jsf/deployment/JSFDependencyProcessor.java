...
public class JSFDependencyProcessor implements DeploymentUnitProcessor {
    ...
    private static final ModuleIdentifier JBOSS_JSF = ModuleIdentifier.create("org.jboss.as.jsf");
    ...
    public void deploy(DeploymentPhaseContext phaseContext) throws DeploymentUnitProcessingException {
        ...
        moduleSpecification.addSystemDependency(new ModuleDependency(moduleLoader, JBOSS_JSF, false, false, true, false));
    }
