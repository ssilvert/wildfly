...
public class NewChartAction extends AbstractAction {
    ...
    public NewChartAction(CliGuiContext cliGuiCtx) {
        super("New Real Time Graph");
        this.cliGuiCtx = cliGuiCtx;
    }

    public void actionPerformed(ActionEvent e) {
        SelectRealTimeAttributeDialog dialog = new SelectRealTimeAttributeDialog(cliGuiCtx);
